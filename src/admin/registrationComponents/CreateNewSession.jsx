...
const CreateNewSession = ({ form, setIsNext, onNewSessionSubmit }) => {
    ...
    return (
        ...
        <div className='w-[90%] md:w-[600px] mt-10 flex-shrink-0 bg-colorWhite1 rounded-md shadow-md md:px-8 px-5 py-5 flex flex-col gap-4 items-center animate__animated animate__fadeInRight'>
            ...
            <form className='w-full flex flex-col gap-4' onSubmit={handleSubmit(onNewSessionSubmit)} noValidate>
                <InputElements type="text" id="sessionName" placeholder="2020/2021 Session" form={form} />
                <InputElements type="select" options={["Quarterly", "Triannual", "Biannual"]} label="Session Frequency" id="sessionFrequency" placeholder="2020/2021 Session" form={form} />
