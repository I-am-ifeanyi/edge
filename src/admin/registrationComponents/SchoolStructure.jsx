    ...
    <>
      <div className="w-[90%] md:w-[600px] md:h-[450px] h-auto mt-10 flex-shrink-0 bg-colorWhite1 rounded-md shadow-md md:px-8 px-5 py-5 flex flex-col gap-4 items-center animate__animated animate__fadeInRight overflow-y-scroll">
        ...
        <form
          ...
          onSubmit={handleSubmit(schoolStructureSummit)}
          noValidate
        >
          <InputElements
            type="select"
            ...
            options={["Primary School", "Secondary School", "Custom"]}
          />
          <p>How many groups are in your school?</p>

          <div
            className={`w-full flex justify-between border border-${
              isGroupSelected === "js-ss" ? "colorLightGreen" : null
            } p-2 gap-1 rounded-md hover:border-colorLightGreen transition-all duration-500 border-2`}
          >
            <div className="w-[10%]">
              <div className="rounded-full w-6 h-6 flex items-center justify-center border-2 border-colorLightGreen">
                <InputElements
                  type="radio"
                  name="schoolGroupType"
                  value="js1-ss3"
                  id="js1-ss3"
                  onClick={() => setIsGroupSelected("js-ss")}
                  form={form}
                />
              </div>
            </div>
            <aside className="w-[90%]">
              ...
              <p className="text-[12px]">
                Choose this if your institution uses the default
                primary/secondary school naming convention for Nigerian Schools.
              </p>
            </aside>
          </div>
          <div
            className={`w-full flex justify-between border border-${
              isGroupSelected === "yr1-yr12" ? "colorLightGreen" : null
            } p-2 gap-1 rounded-md hover:border-colorLightGreen transition-all duration-500 border-2`}
          >
            <div className="w-[10%]">
              <div className="rounded-full w-6 h-6 flex items-center justify-center border-2 border-colorLightGreen">
                <InputElements
                  ...
                  value="yr1-yr12"
                  id="yr1-yr12"
                  onClick={() => setIsGroupSelected("yr1-yr12")}
                  form={form}
                />
              </div>
            </div>
            <aside className="w-[90%]">
              ...
              <p className="text-[12px]">
                Choose this if your institution uses the K12 naming conventions
                used in most British or American schools.
              </p>
            </aside>
          </div>
          ...
          <div className="flex flex-col gap-4 h-12">
            ...
            {isChecked && (
              <div className="text-colorLightGreen flex items-center gap-2 text-sm">
