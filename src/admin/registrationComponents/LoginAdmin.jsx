...
const LoginAdmin = ({ onLoginSubmit, form, isPasswordVisible, passwordChange, togglePasswordVisibility }) => {
    const { register, control, handleSubmit, formState, reset } = form

    return (
        <div className='w-[90%] md:w-[360px] min-h-[360px] flex-shrink-0 bg-white rounded-md shadow-md md:px-8 px-5 py-5 flex flex-col items-center justify-around animate__animated animate__fadeInRight'>
            <h4 className='border-b-2 rounded border-colorBlue'>LOGIN</h4>
